...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let washington = Capital(title: "Washington DC", coordinate: CLLocationCoordinate2D(latitude: 38.895111, longitude: -77.036667), info: "Named after George himself.", url: "https://en.wikipedia.org/wiki/Washington_DC")
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        ...
        let vc = storyboard?.instantiateViewController(withIdentifier: webViewIdentifier)
        if vc != nil, let webVC = vc as? WebViewController {
            webVC.url = URL(string: capital.wikiPage)
    ...
    private let webViewIdentifier = "WebView"
}
